...
function Stat({ icon, title, value }) {
  return (
    <div className="grid w-[20rem] grid-cols-[auto,1fr] grid-rows-[auto,auto] gap-x-[1.6rem] gap-y-[0.4rem] rounded-md border border-gray-100 bg-gray-50 px-12 py-3 shadow-2xl shadow-indigo-200 dark:border-slate-900 dark:bg-slate-900 dark:shadow-slate-800 md:w-full md:px-6">
