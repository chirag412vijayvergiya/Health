...
function ReviewCard({ Doctorname, email, ratings, photo, review, date, id }) {
  ...
  return (
    <div className="m-auto flex h-[13rem] w-[17rem] max-w-xl flex-row justify-between overflow-scroll rounded-xl border-b border-gray-300 bg-gray-50 p-6 tracking-wider shadow-sm shadow-grey-400 dark:border-slate-800 dark:bg-slate-900 dark:shadow-grey-900 md:h-[15rem] md:w-[29rem]">
