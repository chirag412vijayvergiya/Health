...
*/
    //
    <div className="grid-cols-16 justify-centergap-y-12  grid max-w-[115rem] flex-1  content-center items-start justify-items-start dark:bg-slate-900">
      ...
      <div className="absolute bottom-0 right-0 z-[-100] h-80 w-80 rounded-full bg-green-500 opacity-40 blur-[120px] dark:opacity-20"></div>
      <div className=" ml-20 space-y-4 sm:space-y-8">
        <button className="dark:accent-1-06 bg-accent-1-11 dark:border-accent-1-02 mx-auto flex items-center gap-1 rounded-full border border-yellow-600 bg-yellow-100 p-1 px-2 text-[10px] font-medium text-yellow-500 dark:bg-gray-400 sm:px-3 sm:text-sm lg:mx-0 lg:justify-start">
          <p>Start your healing journey with us today</p>
          <IoIosArrowForward />
        </button>
