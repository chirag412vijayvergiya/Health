...
function Features() {
  return (
    <div
      id="features-section"
      className="min-w-screen ltm-landing-bg relative z-[10] flex overflow-hidden bg-grey-50 bg-cover bg-no-repeat dark:bg-gray-900"
    >
          ...
          <div className="flex flex-col items-center justify-center gap-6 md:flex-row-reverse">
            <div className="flex flex-col gap-6 text-left">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <FacilityFeatures type={3}>Precision Imaging</FacilityFeatures>
                <FacilityFeatures type={4}>
                  Compassionate Support
                </FacilityFeatures>
                <FacilityFeatures type={5}>Precision Surgery</FacilityFeatures>
                <FacilityFeatures type={6}>Holistic Wellness</FacilityFeatures>
              </div>
            </div>
          </div>
          <div className="py-5">
